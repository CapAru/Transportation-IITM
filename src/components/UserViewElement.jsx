    ...
    const handleConfirmExtend = async () => {
        try {
            const res = await fetch("/api/extend-validity", {
                ...
                body: JSON.stringify({ id: user.id, validityDateExtended: validityDate }),
            });
            ...
            alert("An error occurred while extending validity.");
        }
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center w-full py-4 px-4 sm:px-8 m-1 bg-amber-200 rounded-3xl hover:bg-amber-300 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 whitespace-nowrap w-full sm:w-auto">
                    ...
                    <button
                        ...
                        className="bg-blue-900 py-2 px-4 sm:py-3 sm:px-6 rounded-2xl text-white text-md w-full sm:w-auto hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 hover:shadow-md active:outline-none active:ring-2 active:ring-blue-500 cursor-pointer"
                    >
                        Extend Validity
                    </button>
                    <button
